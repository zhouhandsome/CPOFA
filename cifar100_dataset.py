...
test_loader = paddle.io.DataLoader(dataset=test_dataset,batch_size=3)
model_state_dict = paddle.load(r'D:\VsCodeProjects\pythonProjects\Smart_Algorithm\model_params\VisionTransformer\save_dir_100.pdparams')
